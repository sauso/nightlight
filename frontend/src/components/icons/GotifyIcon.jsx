// Gotify logo (line art), as a lucide-compatible icon ({ size, color }). Stroke-based → tints via
// `color`. Stroke width is nudged up from the source's hairline so it stays legible at ~22px.
export default function GotifyIcon({ size = 24, color = 'currentColor', ...props }) {
  return (
    <svg
